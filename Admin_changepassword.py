...
"")
    ...
    def retranslateUi(self, Change_Admin_Password):
        ...
        self.toolButton.setText(_translate("Change_Admin_Password", "Change Admin Password"))


class Admin_Password_Change(QDialog,Ui_Change_Admin_Password):
    def __init__(self,parent=None):
        super(Admin_Password_Change,self).__init__(parent)
        self.setupUi(self)
        ...
        config_name = 'admin_password.cfg'
    ...
    def changebtn(self):
        ...
        if self.username == 'admin':
            ...
            QMessageBox.information(self,'Alert','Please enter only ADMIN user')
            self.username_le.clear()
            self.cur_pass_le.clear()
            self.new_pass_le.clear()
