...
class Staff_login(QDialog):
    def __init__(self,parent=None):
        super().__init__(parent)

        self.staffloginwindow()

        self.show()

    def staffloginwindow(self):
        self.title = 'Staff Login Page'
        ...
        self.title_label = QLabel('Staff Login')
    ...
    def loginbtn(self):
        ...
        if len(result)>0 and self.username!='admin':
