...
class Add_Daily_Bill(QDialog,Ui_Daily_bill):
    ...
    def table_records(self):
        ...
        print('The number of rows is ',self.viewtable.rowCount())
        self.combovalue()
    ...
    def newrow(self):
        ...
        self.viewtable.setItem(rowposition-1,0,QTableWidgetItem(str(rowposition)))
        self.viewtable.insertRow(rowposition)

    def combovalue(self):
        self.combolist = set('NA',)
